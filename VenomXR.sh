...
case $os in
    ...
    case $option in
        ...
        echo
        echo "NOTE : "
        echo "Saperated Scripts for forensic Investigation Are available in Forensic folder..!"
        echo
        ;;
        5)
        echo "Enter the IP-Address :"
